...
import { checkoutOrder, getAllOrders, getOrderDetailsStatus, updateOrderStatus, getDashboardStats, getMonthlySales, getUserOrders, getOrderById, getAdminOrderById } from "@/app/api/controller/order-controller"
...
orderRoute.get('/:id/admin', getAdminOrderById)
