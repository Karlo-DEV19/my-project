...
interface OrderSummaryProps {
    items: CartItem[]
    deliveryAddress?: DeliverySummaryInput
}

export const OrderSummary = ({ items, deliveryAddress }: OrderSummaryProps) => {
            ...
            <div className="px-6 py-5 bg-accent/5 border-t border-border flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2.5">
                    ...
                    <div className="flex items-center justify-between text-xs">
                        ...
                        {deliveryFee.status === 'fixed' && (
                            <span className="font-medium text-foreground">
                                {php(deliveryFee.fee)}
                            </span>
                        )}
                        {deliveryFee.status === 'quoted' && (
