        ...
        <section className="relative min-h-[700px] h-[100dvh] w-full flex flex-col overflow-hidden bg-background">
            ...
            <div className="relative z-10 flex-1 flex items-center w-full pt-20 lg:pt-0">
                <div className="container mx-auto px-6 max-w-7xl flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-20 h-full py-8 lg:py-0">
                    ...
                    <div className="w-full lg:w-[45%] flex flex-col justify-center relative z-20 text-center lg:text-left mt-8 lg:mt-0 bg-background/95 p-8 lg:p-12 rounded-2xl shadow-2xl backdrop-blur-md border border-white/10 lg:ml-0 mx-auto max-w-xl lg:max-w-none">
                        ...
                        <p className="text-base lg:text-lg text-muted-foreground leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
