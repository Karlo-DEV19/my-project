...
<body>
  ...
  <div class="totals">
    ...
    ${deliveryFee !== null && deliveryFee > 0 ? `<div class="totals-row"><span>Delivery Fee</span><span>${fc(deliveryFee)}</span></div>` : ''}
  ...
  <div class="footer">Generated on ${new Date().toLocaleString('en-PH')} &nbsp;·&nbsp; MJ Decors Admin Panel</div>
    ...
    }, [o, orderItems, paymentRows, formattedAddress, addressParts, subtotal, vat, deliveryFee, totalAmount, downpayment, balance, fullName]);
                ...
                <section className="px-6 py-5">
                    ...
                    <div className="rounded-lg border border-border bg-muted/30 px-5 py-4 flex flex-col gap-2.5">
                        ...
                        {deliveryFee !== null && deliveryFee > 0 && (
                            <AmountRow label="Delivery Fee" value={formatCurrency(deliveryFee)} />
                        )}
