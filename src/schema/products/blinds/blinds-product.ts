import { pgTable, uuid, varchar, text, integer, real, boolean, timestamp, uniqueIndex } from "drizzle-orm/pg-core";
...
export const blindsProducts = pgTable(
    "blinds_products",
    {
        ...
        // ── Promo / Discount ──────────────────────────────────────────────────
        enablePromo:    boolean("enable_promo").default(false).notNull(),
